...
<colgroup>
  ...
  <tbody>
    <tr>
      ...
      <td class="col-task">- Học Module 01-04: Hạ Tầng Toàn Cầu Của AWS <br> - Tìm hiểu về Regions, Availability Zones, Edge Locations <br> - Nắm được vai trò của từng thành phần trong tính sẵn sàng và khả năng mở rộng</td>
    ...
    <tr>
      ...
      <td class="col-task">- Học Module 01-05: Công Cụ Quản Lý AWS Services <br> - Tìm hiểu các công cụ hỗ trợ quản trị và giám sát dịch vụ AWS <br> - Làm quen với AWS Management Console và các công cụ quản lý tài nguyên</td>
    ...
    <tr>
      ...
      <td class="col-task">- Học Module 01-06: Tối Ưu Hóa Chi Phí Trên AWS và Làm Việc Với AWS Support <br> - Tìm hiểu các phương pháp quản lý chi phí và tối ưu tài nguyên <br> - Tìm hiểu các gói hỗ trợ kỹ thuật của AWS</td>
    ...
    <tr>
      ...
      <td class="col-task">- Thực hiện Module 01-Lab07-04: Creating a Reservation Instance (RI) Budget <br> - Tìm hiểu cơ chế quản lý ngân sách đối với Reserved Instances và theo dõi mức độ sử dụng</td>
